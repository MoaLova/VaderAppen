...
// nej
import SwiftUI
import CoreLocation // Import CoreLocation framework for reverse geocoding
...
struct HourlyWeatherRow: View {
    ...
    private func fetchCityName() {
        ...
        let location = CLLocation(latitude: Double(hourlyWeather.latitude), longitude: Double(hourlyWeather.longitude))
